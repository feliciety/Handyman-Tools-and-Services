...
public class HomePageController {
    ...
    private void displayServices(List<Service> servicesToDisplay) {
        ...
        for (Service service : servicesToDisplay) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/demo/FXMLHomePage/ServiceCard.fxml"));
    ...
    private void showServiceDetails(Service service) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/demo/FXMLHomePage/ServiceInfoCard.fxml"));
